...
public:
    ...
    void setupUi(QDialog *form_groupe)
    {
        ...
        form_groupe->resize(652, 778);
        widget = new QWidget(form_groupe);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(10, 10, 631, 771));
        frame = new QFrame(widget);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(30, 0, 551, 91));
...
"}"));
        ...
        frame_2->setGeometry(QRect(10, 100, 591, 601));
...
"}"));
        ...
        frame_3->setGeometry(QRect(400, 690, 191, 53));
...
"}"));
    ...
    void retranslateUi(QDialog *form_groupe)
    {
        ...
        label_2->setText(QCoreApplication::translate("form_groupe", " Classe :", nullptr));
        comboBox->setItemText(0, QCoreApplication::translate("form_groupe", "L1", nullptr));
